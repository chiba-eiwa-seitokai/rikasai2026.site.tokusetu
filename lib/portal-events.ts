...
export const PORTAL_EVENTS: PortalEvent[] = [
  {
    ...
    imageUrl: "/events/pamphlet/class-1-7.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/class-1-8.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/class-1-9.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/class-2-1.webp",
    day1: true,
    day2: true,
  },
  {
  ...
  },
  {
    ...
    imageUrl: "/events/pamphlet/class-2-5.webp",
    day1: true,
    day2: true,
  },
  {
  ...
  },
  {
    ...
    tags: ["映画", "ホラー", "上映"],
    info: [{ k: "営業時間", v: "9:00-14:00" }],
    imageUrl: "/events/pamphlet/class-3-1.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/class-3-4.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/class-3-7.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-organ.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-kado.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-photo.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-tea.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    tags: ["合唱", "コンサート", "音楽"],
    info: [{ k: "場所", v: "チャペル" }, { k: "営業時間", v: "11:25-12:40" }],
    imageUrl: "/events/pamphlet/club-choir.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-calligraphy.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-cooking.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-art.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-literature.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    imageUrl: "/events/pamphlet/club-theater.webp",
    day1: true,
    day2: true,
  },
  {
    ...
    info: [{ k: "場所", v: "GW2L" }, { k: "営業時間", v: "9:00-14:00" }],
    imageUrl: "/events/pamphlet/club-youth-hostel.webp",
    day1: true,
    day2: true,
  },
];
...
export async function syncPortalEvents(prisma: PrismaClient) {
  ...
  for (const event of PORTAL_EVENTS) {
    ...
    const commonData = {
      ...
      ...(event.imageUrl
        ? { thumbUrl: event.imageUrl, heroImgUrl: event.imageUrl }
        : {}),
    };
